...
<div class="antialiased text-gray-900 px-6">
    ...
    <div class="mx-auto py-12 md:max-w-full">
        <header class="mb-10 flex">
          ...
          <h1 class="text-2xl font-light text-slate-600 border-l-2 border-l-slate-300 py-2 px-10 ml-10">Longtail generator</h1>
        </header>

        <div>
            <h3 class="text-xl text-slate-600 mb-4">Words to combine (comma separated)</h3>
